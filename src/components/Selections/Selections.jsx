...
const Selections = ({selects, cost, hours, remaining}) => {
    return (
        ...
        <div className="lg:max-xl:ml-4 lg:ml-6 mx-auto md:w-1/2 lg:w-1/4 h-full bg-white rounded-xl p-6 mb-10">
            <h2 className='text-[#2F80ED] text-lg font-bold mb-4'>Credit Hour Remaining: {remaining} hr</h2>
            <hr />
            ...
            <hr />
            <h4 className='my-4 opacity-80 font-medium'>Total Credit Hour: {hours}</h4>
            <hr />
